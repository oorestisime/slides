...
import { Code, Step, CodeSurferColumnLayout } from "code-surfer";
...
<Layout>
  ...
  <PointText>By default gatsby generates x2 x4 /2 /4 dimensions</PointText>
  <PointText>
    Calculate image container width and resize image to that width
  </PointText>
  <PointText>Ask gatsby to generate / 2 / 4 and x 2</PointText>
</Layout>
...
<Layout>
  ...
  <Box gap="medium">
    ...
    <PointText>
      Experiment with keeping original images in github and running the optimize
      script before gatsby build
    </PointText>
    <PointText>Cache in CircleCI gatsby build for even better speed</PointText>
  </Box>
</Layout>
...
<Layout>
  ...
  <PointText size="xlarge">
    Many thanks to the following projects that enabled the presentation
  </PointText>
  <Box margin={{ top: "medium" }} gap="small">
    <PointText>Gatsby</PointText>
    <PointText>Netlify</PointText>
    <PointText>CircleCI</PointText>
    <PointText>mdx-deck</PointText>
    <PointText>Grommet</PointText>
    <PointText>Code surfer</PointText>
  </Box>
</Layout>
